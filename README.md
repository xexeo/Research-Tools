...
2. [Gemini (Google)](https://research.google/gemini)
3. [Copilot (Microsoft)](https://github.com/features/copilot)
4. [Bing+GPT (Microsoft)](https://www.bing.com/gpt)

# Warmup

1. [Perplexity](https://www.perplexity.ai/)
2. [Heuristica](https://heuristica.com.br/)

# Search
1. [Scopus (Elsevier)](https://www.scopus.com)
1. [Scielo (mostly Latin America)](https://scielo.org)
1. [ACM Digital Library](https://dl.acm.org/)
1. [IEEE XPlore](https://ieeexplore.ieee.org/)
1. [Portal Periódicos CAPES](https://www.periodicos.capes.gov.br/)

# Select
1. [VosViewer](https://www.vosviewer.com/)
1. [Litmaps](https://www.litmaps.com/)
...
1. [SCISPACE](https://www.scispace.net/)
...
1. [Writefull](https://www.writefull.com/)
...
# Presentation
1. [MagicSlides](https://www.magicslides.com/)
